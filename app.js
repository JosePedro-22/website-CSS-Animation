...
let timeline = gsap.timeline({defaults:{ duration:1.3,
    ease:"power3.inOut",}});
...
image_wrap.addEventListener("mousemove", ()=>{
    ...
    image_wrap.style.backgroundPosition = `calc(50% + ${xMoving * xSpeed}px) calc(28% ${yMoving * ySpeed}px)`; 
});

image_wrap.addEventListener("mousehover", ()=>{
...
image_wrap.addEventListener("mouseout", ()=>{
    ...
    image_wrap.style.backgroundPosition = "50% 28%";
});
